...
func (m *MockHelpers) SortEnvVarsByName(envVars []v1.EnvVar) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SortEnvVarsByName", envVars)
}

// SortEnvVarsByName indicates an expected call of SortEnvVarsByName.
func (mr *MockHelpersMockRecorder) SortEnvVarsByName(envVars any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SortEnvVarsByName", reflect.TypeOf((*MockHelpers)(nil).SortEnvVarsByName), envVars)
}

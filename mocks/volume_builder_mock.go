...
func (m *MockVolumeBuilder) BuildFromUserConfig() ([]v1.Volume, []v1.VolumeMount) {
	m.ctrl.T.Helper()
...
func (mr *MockVolumeBuilderMockRecorder) BuildFromUserConfig() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BuildFromUserConfig", reflect.TypeOf((*MockVolumeBuilder)(nil).BuildFromUserConfig))
}
